...
import firebaseDefaults from "../../public/firebase-config.json";
...
const initFirebaseApp = () => {
  ...
  const apiKey = getEnv("VITE_FIREBASE_API_KEY") || firebaseDefaults.apiKey || "";
  ...
  firebaseAppInstance = initializeApp({
    ...
    authDomain: getEnv("VITE_FIREBASE_AUTH_DOMAIN") || firebaseDefaults.authDomain,

    projectId: getEnv("VITE_FIREBASE_PROJECT_ID") || firebaseDefaults.projectId,

    storageBucket: getEnv("VITE_FIREBASE_STORAGE_BUCKET") || firebaseDefaults.storageBucket,

    messagingSenderId:
      getEnv("VITE_FIREBASE_MESSAGING_SENDER_ID") || firebaseDefaults.messagingSenderId,

    appId: getEnv("VITE_FIREBASE_APP_ID") || firebaseDefaults.appId,

    measurementId:
      getEnv("VITE_FIREBASE_MEASUREMENT_ID") || firebaseDefaults.measurementId || undefined,
